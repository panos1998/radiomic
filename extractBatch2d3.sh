...
pyradiomics --verbosity 5 /home/p/ppetrd/thesisCode/maskSegMatchingMUKERJE_SET1.csv \
  --jobs=6 -o /home/p/ppetrd/mukerjeset1/firstOrderResults2.csv -f csv \
  -p /home/p/ppetrd/thesisCode/params3.yaml


pyradiomics --verbosity 5 /home/p/ppetrd/thesisCode/maskSegMatchingMUKERJE_SET2.csv \
  --jobs=6 -o /home/p/ppetrd/mukerjeset2/firstOrderResults2.csv -f csv \
  -p /home/p/ppetrd/thesisCode/params3.yaml
